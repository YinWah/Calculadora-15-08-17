 ...
 * 
 * @authors:  emmanuel, yin wah, pablo sorzano 
 * @version:  2.0 
 * @date: 15-08-2017 
 */
public class Calculadora extends JFrame {
	...
	public Calculadora() {
		...
		nuevoBotonOperacion("/");
		nuevoBotonOperacion("=");
                //Se agrega el boton de exponenciacion
                nuevoBotonOperacion("^");
                //Se agrega el boton de radicalizacion
		nuevoBotonOperacion("√");
                //Se agrega el boton de logaritmo natural
		nuevoBotonOperacion("ln");
                //Se agrega el boton de la funcion Seno
		nuevoBotonOperacion("Sen()");
                //Se agrega el boton de la funcion Coseno
	...
	private void calcularResultado() {
		if (operacion.equals("+")) {
			...
			resultado *= new Double(pantalla.getText());
                ...
                /**
                * Indica que la base tecleada se elevara al exponte indicado
                 */
                else if(operacion.equals("^")){
                        resultado = Math.pow(resultado,new Double(pantalla.getText()));
                }
                /**
                * Indica el numero tecleado se elevara al exponente 1/2
                 */
                else if(operacion.equals("√")){
                        resultado = Math.sqrt(resultado);
                }
                /**
                * Indica se aplicara un logaritmo base 'e' al numero tecleado
                 */
                else if(operacion.equals("ln")){
                        resultado = Math.log(resultado);
                }
                /**
                * Indica que se le aplicara la funcion trigonometrica ´Seno´
                 */
                else if(operacion.equals("Sen()")){
                        resultado = Math.sin(resultado);
                }
                /**
                * Indica que se le aplicara la funcion trigonometrica ´Coseno´
                 */
